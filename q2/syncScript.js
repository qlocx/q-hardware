...
console.log("\n===== Glöm inte att kortet ska ha ström =====")
...
try {
    ...
    console.log(e.execSync(`lp -d ${printerName} ${__dirname}/bleid.txt -o landscape -o page-top=15 -o media=Custom.12x22mm`).toString())
} catch (e) {
    // console.log(e)
}
